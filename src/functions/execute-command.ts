...
export const executeCommandFunction: FunctionDefinition = {
  ...
  parameters: {
    ...
    properties: {
      ...
      reasoning: {
        type: 'string',
        description: 'Explanation of what this command will do and why it was chosen'
      }
    },
 ...
 */
export const executeCommandHandler = async (args: Record<string, any>): Promise<string> => {
