...
window.MultimodalWebSurfer = window.MultimodalWebSurfer || (function () {
    ...
    /**
     * Gets the computed cursor style for an element
    ...
    /**
     * Finds all interactive elements on the page using three methods:
     * 1. Standard interactive HTML elements
     * 2. Elements with interactive ARIA roles
     * 3. Elements with interactive cursor styles
     * @returns {Array<HTMLElement>} Array of interactive elements
     */
    ...
    /**
     * Assigns unique IDs to elements that don't already have one
     * @param {Array<HTMLElement>} elements - Elements to label
     */
     ...
     * @returns {string|null} Element ID or null if none found
     */
    ...
    /**
     * Gets trimmed inner text of an element, handling null cases
     * @param {HTMLElement} element - Element to get text from
     * @returns {string} Trimmed inner text or empty string
     */
    ...
    /**
     * Gets the accessible name of an element using various ARIA attributes
     * Checks aria-labelledby, aria-label, labels, alt text, and titles
     * @param {HTMLElement} element - Element to get name for
     * @returns {string} Accessible name of the element
     */
    let getApproximateAriaName = function (element) {
        ...
        if (element.hasAttribute("id")) {
            ...
            let label = "";
            let labels = document.querySelectorAll(`label[for="${CSS.escape(label_id)}"]`);
    ...
    /**
     * Gets the ARIA role and original tag name of an element
     * @param {HTMLElement} element - Element to check
     * @returns {Array} [aria role, tag name]
     */
    ...
    /**
     * Gets bounding rectangles and metadata for all interactive elements
     * @returns {Object} Map of element IDs to their properties and positions
     */
    ...
    /**
     * Gets information about the current visual viewport
     * @returns {Object} Viewport properties including dimensions and scroll position
     */
     ...
     * @returns {Object} Map of meta tag names/properties to their content
     */
     ...
     * @returns {Array} Array of JSON-LD data strings
     */
     ...
     * Parses nested itemscope/itemprop structures
     * @returns {Array} Array of parsed microdata objects
     */
    ...
    /**
     * Collects all metadata from the page including JSON-LD, microdata, and meta tags
     * @returns {Object} Combined metadata from all sources
     */
    ...
    /**
     * Gets all visible text within the current viewport
     * Handles text nodes and their layout, adding appropriate line breaks
     * @returns {string} Visible text content, formatted with newlines
     */
